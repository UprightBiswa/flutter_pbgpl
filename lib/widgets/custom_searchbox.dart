...
class ProjectInfoWidgettwo extends StatelessWidget {
  const ProjectInfoWidgettwo({super.key});
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: Text(
                '(Registration free till 31st March 2024 for Gas connection. Post 31st March 2024 registration will be chargeable @275 INR)',
